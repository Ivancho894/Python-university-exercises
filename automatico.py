...
cuerto=0
def manual():
   global moto,auto,efectivo,telepeaje,mayor,camion,nueva,cantefe,canttelep,tipo, forma, patente,sonlas,tiempo
...
def automatico():
   global moto,auto,efectivo,telepeaje,camion,cantefe,primer,canttelep,tiempo,mayor,nueva,patente,tipo,forma,precio,numeros,sonlas,primer,segundo,tercero,cuerto
...
def printeos():
   ...
   if efectivo<telepeaje:
      ...
      print("Las pasadas con efectivo fueron mayores que con telepeaje")
   print("La patente mas nueva fue: ",mayor," y paso a los ",round(hora,0),"minutos desde que empezo el turno")
